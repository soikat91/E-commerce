   ...
   static function  InitiatePayment($Profile,$payable,$tran_id,$user_email): array
   {
      try{
          ...
          $response = Http::asForm()->post($ssl->init_url,[
            ...
            "tran_id"=>$tran_id,
            "success_url"=>"$ssl->success_url?tran_id=$tran_id",//query string hisabe pathano hoice tran-id k
    ...
    static function paymentSuccess($tran_id){
